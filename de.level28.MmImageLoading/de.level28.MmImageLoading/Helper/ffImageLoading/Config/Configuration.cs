...
namespace MmImageLoading.Config
{
    /// <summary>
    /// Configuration.
    /// </summary>
    public class Configuration
    {
        ...
        /// <summary>
        /// Gets or sets a value that determines whether upscaling should be used in <see cref="MmImageLoading.Work.TaskParameter.DownSample"/>/<see cref="MmImageLoading.Work.TaskParameter.DownSampleInDip"/> functions if the image is smaller than passed dimensions
        /// </summary>
