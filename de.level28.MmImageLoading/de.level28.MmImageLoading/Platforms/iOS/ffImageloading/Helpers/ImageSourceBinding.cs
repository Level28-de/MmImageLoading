...
namespace MmImageLoading.Forms.Platform.iOS
{
    [Preserve(AllMembers = true)]
    internal class ImageSourceBinding : IImageSourceBinding
    {
        public ImageSourceBinding(MmImageLoading.Work.ImageSource imageSource, string path)
        {
        ...
        {
            ImageSource = MmImageLoading.Work.ImageSource.Stream;
            Stream = stream;
        }

        public MmImageLoading.Work.ImageSource ImageSource { get; private set; }
        ...
        internal static ImageSourceBinding GetImageSourceBinding(ImageSource source, CachedImage element = null)
        {
            ...
            if (uriImageSource != null)
            {
                ...
                return new ImageSourceBinding(MmImageLoading.Work.ImageSource.Url, uri);
            }
            ...
            if (fileImageSource != null)
            {
                ...
                if (fileImageSource.File.StartsWith("/", StringComparison.InvariantCultureIgnoreCase) && File.Exists(fileImageSource.File))
                    return new ImageSourceBinding(MmImageLoading.Work.ImageSource.Filepath, fileImageSource.File);

                return new ImageSourceBinding(MmImageLoading.Work.ImageSource.CompiledResource, fileImageSource.File);
            }
            ...
            if (embeddedResoureSource != null)
            {
                ...
                return new ImageSourceBinding(MmImageLoading.Work.ImageSource.EmbeddedResource, uri);
            }
            ...
            if (dataUrlSource != null)
            {
                ...
                return new ImageSourceBinding(MmImageLoading.Work.ImageSource.Url, dataUrlSource.DataUrl);
            }
